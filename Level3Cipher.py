...
class SystemGUI:
    def __init__(self):
        self.counter = 0
        self.window = tk.Tk()
        self.window.title("System 223")
        self.window.configure(bg='black')

        title_label = tk.Label(self.window, text="System 223", font=("Arial", 20), bg='black', fg='white')
        title_label.pack(pady=20)

        title_label1 = tk.Label(self.window, text='''"For numbers a bird Seen, In Lines and Strikes Heard"''', font=("Arial", 12, "bold"), bg="black", fg="green")
    ...
    def show_spike(self):
        ...
        label = tk.Label(new_window, text="Signal [160.2]", font=("Arial", 20))
        label.pack(pady=20)
